...
ax_power_u.plot(u_down, P_down_available * 1E-6, 'o', color='red')
ax_power_u.plot(u_down, P_down * 1E-6, 'x', color='orange', label=fr"$\eta_{{\mathrm{{down}}}}$ = {factor_down:.2f}, $P_{{\mathrm{{down}}}}$ = {P_down:.0f}")
